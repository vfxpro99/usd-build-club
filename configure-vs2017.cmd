...
REM if "%~1"=="debug" (set tbb_debug="-DTBB_USE_DEBUG_BUILD:INT=1")
REM if "%~1"=="debug" (set tbb_lib="tbb_debug.lib")
REM if "%~1"=="Debug" (set tbb_debug="-DTBB_USE_DEBUG_BUILD:INT=1")
REM if "%~1"=="Debug" (set tbb_lib="tbb_debug.lib")
REM echo "configuring for %tbb_debug% *******"
...
cmake "%~1" ^
      ...
      -DHDF5_ROOT="%builddir%" ^
      -DTBB_INCLUDE_DIRS="%builddir%/include" ^
